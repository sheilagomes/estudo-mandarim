...
function novaFrase() {
	document.querySelector(".frase-original").innerHTML = `${frases[novaFrase][0]}`;
	document.querySelector(".frase-pinyin").innerHTML = `${frases[novaFrase][1]}`;
	document.querySelector(".frase-hanzi").innerHTML = `${frases[novaFrase][2]}`;
