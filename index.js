...
const frases  = [["Eu estou bem", "wǒ hěn hǎo", "我很好"], ["Seu pai é professor", "nǐ de bàba shì lǎoshī", "你的爸爸是老师"], ["Eu sou o professor de vocês", "wǒ shì nǐmen de lǎoshī", "我是你们的老师"], ["Ele é meu irmão mais velho, não é meu colega de estudo", "tā shì wǒ de gēgē, búshì wǒ de tóngxué", "他是我的哥哥,不是我的同学"], ["O seu professor é amigo da minha mãe", "nǐ de lǎoshī shì wǒ de māmā de péngyǒu", "你的老师是我的妈妈的朋友"], ["O senhor Lin é amigo do professor", "línxiānshēng shì lǎoshī de péngyǒu", "林先生是老师的朋友"], ["Eu não me chamo anna", "wǒ bú jiào ānnà", "我不叫安娜"]]
...
for (let i = 0; i < montagemFrase.length - 1; i++) {
	montagemFrase[i].addEventListener("click", function() {
		if (montagemFrase[i].innerHTML == frases[fraseInicial][2][i]) {
